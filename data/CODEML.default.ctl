      seqfile = pal2nal_out_one_line.fa.reord.phy            * Path to the alignment file
     treefile = best_nobl.tree           * Path to the tree file
      outfile = codeml_out.txt            * Path to the output file
    ...
    cleandata = 0              * Remove sites with ambiguity data?
        ...
        model = 1         * Models for ω varying across lineages
